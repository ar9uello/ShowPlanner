...
{
    public class ShowPlannerDbSchemaMigrator : IShowPlannerDbSchemaMigrator , ITransientDependency
    {
        private readonly IServiceProvider _serviceProvider;

        public ShowPlannerDbSchemaMigrator(IServiceProvider serviceProvider)
        {
