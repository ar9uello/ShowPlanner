...
namespace ShowPlanner.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update ShowPlannerDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update ShowPlannerEfCoreEntityExtensionMappings to extend the IdentityUser entity
